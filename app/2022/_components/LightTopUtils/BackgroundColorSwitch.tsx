  ...
  return (
    <div>
      <button
        ...
        title={selectedBackground === 'light' ? '다크모드로 변경' : '라이트모드로 변경'}
      >
        <figure style={{ width: '20px', height: '20px' }}>
          ...
          {selectedBackground === 'light' ? (
            <Image width={20} height={20} src='/images/sun.png' alt='sun' style={{ objectFit: 'contain' }} />
          ) : (
            <Image width={20} height={20} src='/images/moon.png' alt='moon' style={{ objectFit: 'contain' }} />
          )}
        </figure>
